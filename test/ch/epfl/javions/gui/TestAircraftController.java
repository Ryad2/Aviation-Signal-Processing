...
public final class AircraftControllerTest extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        // … à compléter (voir TestBaseMapController)
        Path tileCache = Path.of("/Users/ethanboren/Desktop/EPFL/Unif/Cours/BA2/Programmation/Projet/Javions/tile-cache");
        TileManager tm =
                new TileManager(tileCache, "tile.openstreetmap.org");
        MapParameters mp =
                new MapParameters(17,17_389_327,11_867_430);
        ...
        var mi =
                readAllMessages("/Users/ethanboren/Desktop/EPFL/Unif/Cours/BA2/" +
                        "Programmation/Projet/Javions/resources/messages_20230318_0915.bin")
                        .iterator();
